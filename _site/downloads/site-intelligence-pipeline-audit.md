...
Updated: 2026-07-31T06:43:40.865Z
...
- **GREEN · Collect · fresh-current-news:** 52 news item(s) are inside the active seven-day window. Fix: Keep the homepage empty rather than showing stale news when this count reaches zero.
...
- **GREEN · Automate · daily-automation:** 178 workflow file(s) scanned for daily scheduling. Fix: Keep one canonical daily intake/conclusion/clock workflow and retire overlapping legacy schedules.
