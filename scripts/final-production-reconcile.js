...
requireMarker('membership.html', 'Paid memberships are opening soon. Free Member registration is available now.');
requireMarker('membership.html', 'Create or access free account');
requireMarker('membership.html', 'membership-terms.html');
requireMarker('membership.html', 'terms-of-use.html');
requireMarker('membership.html', 'Checkout approval alone never grants access.');
...
rejectMarker('membership.html', 'Join Placeholder');
rejectMarker('membership.html', 'Monthly donation');
rejectMarker('membership.html', 'activation gates');
