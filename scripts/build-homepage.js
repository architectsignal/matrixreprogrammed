...
<section class="section wrap split"><div class="card"><h2>Signal Intel Desk</h2><p>Short source-led bulletins on wars, declassified files, court records, Epstein-related public records, WikiLeaks/archive drops, sanctions, surveillance, censorship, and crime-state overlap.</p><div class="cta-row small"><a class="btn" href="news.html">Latest 7 Days</a><a class="btn alt" href="intel-archive.html">Bulletin Archive</a></div></div><div class="card redline"><h2>The Signal Board</h2><p>Drop sources, ask questions, request book paths, and submit human-cost updates. Public posts appear only after review.</p><div class="cta-row small"><a class="btn" href="forum.html">Open Signal Board</a><a class="btn alt" href="news.html#human-cost">Human Cost</a></div></div></section>
<section class="section wrap"><div class="card redline"><h2>Join The Signal</h2><p>Request The Black File and enter the archive through thirty-three systems, reader pathways, and one map through the machine.</p><form name="black-file" method="POST" data-netlify="true"><input type="hidden" name="form-name" value="black-file" /><input name="email" type="email" placeholder="your@email.com" /><button class="btn" type="submit">Request The Black File</button></form></div></section>
