...
} else if (!worker.includes('membership compatibility audit markers:')) {
  worker = worker.replace('function hasMembersDb(env)', legacyAuditMarker + 'function hasMembersDb(env)');
}
