...
const legacyFirstBrief = emailLifecycle.includes('queueImmediateDailyBrief') && emailLifecycle.includes("messageKind:'first_daily_brief'");
...
check('immediate-first-brief', legacyFirstBrief || currentFirstBrief, 'Verification does not queue a preference-gated immediate first daily brief with same-day deduplication');
