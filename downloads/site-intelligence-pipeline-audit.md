...
Updated: 2026-07-17T06:31:15.289Z
...
- **GREEN · Collect · fresh-current-news:** 17 news item(s) are inside the active seven-day window. Fix: Keep the homepage empty rather than showing stale news when this count reaches zero.
...
- **GREEN · Automate · daily-automation:** 91 workflow file(s) scanned for daily scheduling. Fix: Keep one canonical daily intake/conclusion/clock workflow and retire overlapping legacy schedules.
