...
needText('.github/workflows/auto-update-orchestrator.yml', 'patch-newsletter-capture-ui.js', 'newsletter UI patch in orchestrator');
...
needFile('scripts/patch-newsletter-capture-ui.js');
...
needText('scripts/patch-newsletter-capture-ui.js', 'data-newsletter-form', 'capture UI patch form');
needText('scripts/patch-newsletter-capture-ui.js', 'Cloudflare Worker newsletter capture', 'remove stale Netlify wording');
for (const page of ['optin-center.html','download-center.html','index.html']) {
  needText(page, 'newsletter.js', `${page} newsletter script`);
  needText(page, 'newsletter-capture', `${page} newsletter capture panel`);
}
...
needText('.github/workflows/deploy-production.yml', 'patch-newsletter-capture-ui.js', 'deploy newsletter UI patch');
