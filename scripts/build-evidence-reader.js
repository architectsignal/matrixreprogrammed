...
const safeHtml = html.replace('id="reader-original" href="#"', 'id="reader-original" aria-disabled="true"');
fs.writeFileSync(path.join(root, 'evidence-reader.html'), safeHtml);
fs.writeFileSync(path.join(root, 'evidence-reader'), safeHtml);
