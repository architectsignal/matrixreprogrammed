...
Updated: 2026-08-02T12:47:46.623Z
...
- **GREEN · Collect · fresh-current-news:** 42 news item(s) are inside the active seven-day window. Fix: Keep the homepage empty rather than showing stale news when this count reaches zero.
...
- **GREEN · Automate · daily-automation:** 193 workflow file(s) scanned for daily scheduling. Fix: Keep one canonical daily intake/conclusion/clock workflow and retire overlapping legacy schedules.
