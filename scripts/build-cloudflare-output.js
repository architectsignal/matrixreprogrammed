...
console.log(`Cloudflare output ready: ${count.length} deployable files, including public source-change summaries while private evidence snapshots and diagnostics remain excluded.`);
