...
if (count(html, 'data-lab.html') < 1) throw new Error('Homepage Public Data Lab route is missing.');
...
if (count(startHere, 'book-universe.html') < 1 || count(startHere, 'forum.html') < 1 || count(startHere, 'power-atlas.html') < 1) throw new Error('Start Here compatibility routes are missing.');
...
console.log('Primary navigation reconciled across legacy and current homepage shells; Public Data Lab, safety routes and the polished Start Here shell are present.');
