...
function patchObsoleteFamilyRoute(html) {
  return html.replace(/track-the-families\.html/gi, 'elite-family-tracker.html');
}
...
runRequired('scripts/run-exposure-integrity-engine.js');
...
runRequired('scripts/install-consequence-evidence-worker.js');
runRequired('scripts/finalize-accountability-tracker-runtime.js');
runRequired('scripts/accountability-tracker-pressure-test.js');
runRequired('scripts/finalize-accountability-review-inbox.js');
