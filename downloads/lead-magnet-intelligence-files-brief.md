# Intelligence Files Starter Brief

A declassified-history starter brief for readers entering the intelligence dossiers, agency maps, source-methodology pages, and public-record archive routes.

## Branded PDF Mini Book

- PDF: downloads/lead-magnet-intelligence-files-brief.pdf
...
Get the agency archive route: how to enter declassified files, separate official record from inference, and move into the intelligence dossier reading path.

## Reader Outcome

The reader can start researching agency files without treating every declassified fragment as a complete conclusion.
...
- Which archive routes matter first: declassified files, oversight records, agency releases, and public dockets.
- How to separate source, inference, allegation, and conclusion.
- How the Intelligence Dossiers series is organised as a reading path.
- Why the source-methodology page is the safety rail for darker material.

## Checklist

- Open the declassified archive evidence lane.
- Read the source-methodology page.
- Pick one agency dossier first.
- Map claim strength before sharing.
- Use the Intelligence offer route for the complete path.

## Action Steps

- Open the Intelligence Dossiers page.
- Open the declassified archive lane.
- Read the source-methodology page.
- Move into the Intelligence Dossiers offer.

## Routes

- Primary: book-intelligence-dossiers.html
- Thank you: black-file-thank-you.html
- Offer: offer-intelligence-dossiers.html
- Campaign: campaign-intelligence-dossiers-push.html
- Share kit: share-kit-intelligence-network.html
- Download route: dossier-pack-intelligence-network.html
- Trust: trust-source-methodology.html
- Privacy: trust-privacy-policy.html
- Evidence: evidence-lane-declassified-archives.html
- Evidence route: evidence-lane-declassified-archives.html
- Evidence route: trust-source-methodology.html
- Evidence route: book-intelligence-dossiers.html
- Evidence route: evidence-vault.html

## Deliverables

- Agency reader path
- Declassified archive route
- Source hierarchy notes
- Intelligence offer path
- Research checklist
- Claim-strength reminder

## Next Best Step

Enter the Intelligence Dossiers offer path.
