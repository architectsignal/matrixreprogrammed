...
Scanned pages: 3466
Flagged pages: 3126
High priority pages: 1591
Medium priority pages: 1533
Pages with missing rules: 750
Auto-update eligible figures: 2
Manual-review figures: 106
Missing-rule figures: 1653

## High Priority Pages
- _site/review-dashboard.html: 24 figure/stat markers; 24 missing rules. Add figure-source rules before automatic replacement.
- review-dashboard.html: 24 figure/stat markers; 24 missing rules. Add figure-source rules before automatic replacement.
- _site/document-library.html: 20 figure/stat markers; 20 missing rules. Add figure-source rules before automatic replacement.
...
- _site/weekly-investigation-report.html: 6 figure/stat markers; 6 missing rules. Add figure-source rules before automatic replacement.
...
- _site/death-file-anna-politkovskaya.html: 5 figure/stat markers; 5 missing rules. Add figure-source rules before automatic replacement.
- _site/death-file-arshad-sharif.html: 5 figure/stat markers; 5 missing rules. Add figure-source rules before automatic replacement.
- _site/death-file-daniel-pearl.html: 5 figure/stat markers; 5 missing rules. Add figure-source rules before automatic replacement.
...
- _site/weekly-investigation-report.html: 6 figure(s) need source rules.
...
- _site/death-file-anna-politkovskaya.html: 5 figure(s) need source rules.
- _site/death-file-arshad-sharif.html: 5 figure(s) need source rules.
- _site/death-file-daniel-pearl.html: 5 figure(s) need source rules.
- _site/death-file-danny-casolaro.html: 5 figure(s) need source rules.
- _site/death-file-daphne-caruana-galizia.html: 5 figure(s) need source rules.
- _site/death-file-don-bolles.html: 5 figure(s) need source rules.
- _site/death-file-dorothy-kilgallen.html: 5 figure(s) need source rules.
- _site/death-file-hrant-dink.html: 5 figure(s) need source rules.
- _site/death-file-jamal-khashoggi.html: 5 figure(s) need source rules.
- _site/death-file-jan-kuciak.html: 5 figure(s) need source rules.
- _site/death-file-lasantha-wickrematunge.html: 5 figure(s) need source rules.
- _site/death-file-marie-colvin.html: 5 figure(s) need source rules.
- _site/death-file-peter-r-de-vries.html: 5 figure(s) need source rules.
