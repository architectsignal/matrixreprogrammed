...
console.log(`Cloudflare output ready: ${count.length} deployable files, including gated member OSINT tools, Phase 5 evidence-led network maps, Search V3 and structured data while private runner code and diagnostics remain excluded.`);
