...
A broad but useful map for readers who want books, offers, launches, share kits, feeds, download packs, evidence routes, and the full Matrix Reprogrammed reading order in one pathway.

## Branded PDF Mini Book

- PDF: downloads/lead-magnet-full-archive-map.pdf
...
Get the full map of the Matrix Reprogrammed archive: books, evidence lanes, free briefs, live intel, offers, and the cleanest route through them.

## Reader Outcome

The reader gets a complete navigation map rather than a random pile of pages.
...
- Where to start if you are new to the site.
- Which book series fits which interest: intelligence, crime, symbolic power, survival, trust, or Black File.
- How free briefs, offers, downloads, videos, and live intel connect.
- Which trust/evidence pages to check before entering controversial material.

## Checklist

- Start at the Book Universe.
- Choose one reader path.
- Open the Evidence Vault for source context.
- Use the Launch Room for campaigns.
- Use the Offer Center when ready to buy.

## Action Steps

- Open the Book Universe.
- Choose a reader path.
- Save the Download Center.
- Enter the Full Archive offer.

## Routes

- Primary: book-universe.html
- Thank you: black-file-thank-you.html
- Offer: offer-full-archive.html
- Campaign: launch-room.html
- Share kit: share-center.html
- Download route: download-center.html
...
- Evidence route: download-center.html
- Evidence route: sales-ladder.html
...
- Evidence/funnel navigation map

## Next Best Step

Open the Book Universe and choose the reader path that fits your interest.
