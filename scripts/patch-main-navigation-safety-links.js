...
const startNavHtml = '<nav class="nav" aria-label="Start Here navigation"><a href="start-here.html" aria-current="page">Start Here</a><a href="security-privacy.html">Security Tools</a><a href="dark-web-safety.html">Dark Web Safety</a><a href="book-universe.html">Book Universe</a><a href="forum.html">Signal Board</a><a href="search.html">Search</a><a href="index.html">Home</a></nav>';
...
console.log('Primary navigation reconciled; Start Here safety, Book Universe and Signal Board routes recreated after legacy generators.');
