...
const requiredSource = [
  ...
  'src/worker.js','src/worker-forum-persistence.js','src/worker-member-experience.js','src/worker-paypal-subscriptions.js','src/worker-production.js','src/worker-production-autonomy.js','src/worker-ai-management.js','src/worker-release-metadata.js','src/worker-public-investigation.js','src/public-investigation-contract.js','src/worker-living-matrix.js','src/worker-value-hunter.js','src/worker-bounty-engine.js','src/worker-permissionless-value.js','src/worker-matrix-operations.js','src/matrix-event-emitter.js','ai-management/living-matrix/living-matrix-cycle.mjs','ai-management/public-investigation/official-fresh-source-director.mjs','ai-management/matrix-core/matrix-constitution.mjs','ai-management/matrix-core/matrix-operating-system.mjs','ai-management/matrix-core/matrix-evolution-director.mjs','ai-management/value-hunter/matrix-capital-challenge.mjs','ai-management/value-hunter/value-hunter-core.mjs','ai-management/value-hunter/financial-firewall.mjs','ai-management/value-hunter/value-collector.mjs','ai-management/value-hunter/bounty/bounty-completion-engine.mjs','ai-management/value-hunter/bounty/bounty-source-adapters.mjs','ai-management/value-hunter/permissionless/permissionless-core.mjs','ai-management/value-hunter/permissionless/permissionless-value-director.mjs','ai-management/value-hunter/permissionless/adapters/morpho-liquidation-v1.mjs','ai-management/provider-adapters/value/official-html-links.mjs',
  ...
  'migrations/public_investigation_api.sql','migrations/phase14_living_matrix.sql','migrations/phase15_matrix_value_hunter.sql','migrations/phase16_permissionless_value_harvester.sql','migrations/phase17_matrix_operating_system.sql','migrations/phase18_matrix_continuous_evolution.sql','migrations/phase19_matrix_capital_challenge.sql','migrations/phase20_bounty_completion_engine.sql','migrations/phase21_fresh_investigation_proof.sql','matrix-system-manifest.json',
  ...
  'scripts/patch-release-metadata-routing.js','scripts/publish-release-metadata-assets.js','scripts/verify-live-ai-management.mjs','scripts/full-system-local-compute-proof.mjs','scripts/living-matrix-acceptance-test.mjs','scripts/publish-investigation-matrix-events.mjs','scripts/value-hunter-golden-test.mjs','scripts/value-hunter-worker-integration-test.mjs','scripts/phase15-value-hunter-contract-test.mjs','scripts/permissionless-harvester-golden-test.mjs','scripts/phase16-permissionless-harvester-contract-test.mjs','scripts/permissionless-harvester-worker-integration-test.mjs','scripts/matrix-operating-system-contract-test.mjs','scripts/matrix-continuous-evolution-contract-test.mjs','scripts/matrix-capital-challenge-contract-test.mjs','scripts/bounty-completion-engine-contract-test.mjs','scripts/bounty-source-adapters-test.mjs','scripts/bounty-worker-integration-test.mjs','scripts/official-fresh-source-director-test.mjs','scripts/fresh-public-investigation-worker-integration-test.mjs','scripts/matrix-operating-system-worker-integration-test.mjs','scripts/phase17-migration-rehearsal.mjs','scripts/phase18-migration-rehearsal.mjs','scripts/phase19-migration-rehearsal.mjs','scripts/phase20-migration-rehearsal.mjs','scripts/phase21-migration-rehearsal.mjs','scripts/ai-management-autonomy-test.mjs','scripts/verify-one-shot-production-authorization.js',
...
for (const text of ['binding = "FORUM_POSTS"','binding = "MEMBERS_DB"','directory = "./_site"','keep_vars = true','AI_RESOURCE_ZERO_SPEND_LOCK = "true"','MATRIX_PERMISSIONLESS_VALUE_ENABLED = "false"','MATRIX_PERMISSIONLESS_AUTO_EXECUTION_ENABLED = "false"','MATRIX_OPERATING_SYSTEM_ENABLED = "true"','MATRIX_EVOLUTION_DIRECTOR_ENABLED = "true"','MATRIX_CAPITAL_CHALLENGE_ENABLED = "true"','MATRIX_CAPITAL_FINANCIAL_EXECUTION_ENABLED = "false"','MATRIX_BOUNTY_ENGINE_ENABLED = "true"','MATRIX_BOUNTY_AUTO_CLAIM_ENABLED = "false"','MATRIX_BOUNTY_AUTO_SUBMISSION_ENABLED = "false"','MATRIX_SECURITY_BOUNTY_EXECUTION_ENABLED = "false"']) {
...
if (hardFreeze) {
  ...
  for (const text of ['migrations/phase9_ai_resource_orchestration.sql','migrations/phase10_ai_autonomy.sql','migrations/phase14_living_matrix.sql','migrations/phase15_matrix_value_hunter.sql','migrations/phase16_permissionless_value_harvester.sql','migrations/phase17_matrix_operating_system.sql','migrations/phase18_matrix_continuous_evolution.sql','migrations/phase19_matrix_capital_challenge.sql','migrations/phase20_bounty_completion_engine.sql','migrations/phase21_fresh_investigation_proof.sql','AI_RESOURCE_ZERO_SPEND_LOCK = "true"','MATRIX_PUBLIC_INVESTIGATION_FRESH_SOURCES_ENABLED = "true"','MATRIX_VALUE_HUNTER_ENABLED = "true"','MATRIX_VALUE_AUTO_COLLECTION_ENABLED = "true"','MATRIX_OPERATING_SYSTEM_ENABLED = "true"','MATRIX_CAPITAL_CHALLENGE_ENABLED = "true"','MATRIX_CAPITAL_FINANCIAL_EXECUTION_ENABLED = "false"','MATRIX_BOUNTY_ENGINE_ENABLED = "true"','MATRIX_BOUNTY_AUTO_CLAIM_ENABLED = "false"','MATRIX_BOUNTY_AUTO_SUBMISSION_ENABLED = "false"','MATRIX_SECURITY_BOUNTY_EXECUTION_ENABLED = "false"','node scripts/verify-live-ai-management.mjs']) {
