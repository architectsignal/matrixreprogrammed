...
- _site/entity-registry.html: 4 figure/stat markers; 4 missing rules. Add figure-source rules before automatic replacement.
...
- death-file-anna-politkovskaya.html: 4 figure/stat markers; 4 missing rules. Add figure-source rules before automatic replacement.
- death-file-boris-nemtsov.html: 4 figure/stat markers; 4 missing rules. Add figure-source rules before automatic replacement.
- dossier-george-nader.html: 4 figure/stat markers; 4 missing rules. Add figure-source rules before automatic replacement.
...
- _site/entity-registry.html: 4 figure(s) need source rules.
...
- dossier-george-nader.html: 4 figure(s) need source rules.
...
- _site/death-file-alexei-navalny.html: 3 figure(s) need source rules.
