...
// This generator owns the command-brief write boundary. Re-run conclusion
// synthesis before returning so direct invocations cannot publish a brief that
// silently drops its evidence boundary, counterpoint, or speculation label.
require('./build-mission-brief-conclusions.js');
