...
const manifest={ok:missing.length===0,title:'Matrix Reprogrammed Card Download Manifest',updated:new Date().toISOString(),boundary:'Card downloads are visual gateways. Evidence, current Intel and scoring live in linked dossiers and source routes.',cardContractVersion:'1.5',expectedCardsPerDeck:52,totalDecks:decks.length,totalCards:decks.reduce((n,d)=>n+d.cards.length,0),missing,downloadHub:'card-downloads.html',decks};
