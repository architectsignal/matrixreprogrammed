...
for (const marker of ['Cloudflare D1 MEMBERS_DB.forum_posts','INSERT INTO forum_posts','D1 did not confirm the forum insert','D1 forum read-after-write confirmation failed','kv_forum_migration_v1','D1 authoritative; KV compatibility mirror']) needText('src/worker-forum-persistence.js', marker, `D1 forum marker ${marker}`);
