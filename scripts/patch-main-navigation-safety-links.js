...
if (count(startHere, 'amazon-store-books.html') < 1 || count(startHere, 'videos.html') < 1) {
  throw new Error('Start Here displaced mission routes are missing.');
}
