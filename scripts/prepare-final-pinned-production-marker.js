...
Boundary: do not bypass the Cloudflare billing-period lock or zero-spend policy; credential, rollback, migration, evidence-label, payment, human-review and exact live-verification gates remain mandatory; the release freeze stays active until exact proof passes
Nonce: ${nonce}
`;
