...
Updated: 2026-07-28T06:59:43.199Z
...
- **GREEN · Collect · fresh-current-news:** 47 news item(s) are inside the active seven-day window. Fix: Keep the homepage empty rather than showing stale news when this count reaches zero.
...
- **GREEN · Publish · brief-coverage:** 74 brief page(s) received the mission interpretation layer. Fix: Apply the final mission lens after all legacy brief generators and audit every brief route.
