...
assert.equal(classifyAiManagementResponse({
  status: 200,
  origin: 'cloudflare-worker-ai-management',
  contentType: 'application/json',
  data: { ok: true }
}, context).code, 'worker-healthy');
...
console.log('Live AI verification classifier passed all eight required failure classes plus healthy Worker routing.');
