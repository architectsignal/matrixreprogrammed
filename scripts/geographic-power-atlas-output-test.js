...
for(const rel of ['geographic-power-atlas.html','geographic-power-atlas','geographic-power-atlas.js','data/geographic-power-atlas.json','data/geographic-power-atlas-data.json','data/geographic-power-atlas-seed.json','downloads/geographic-power-atlas.csv','index.html','research-tools.html','security-privacy.html','dark-web-safety.html','search-index.json','sitemap.xml','llms.txt']) add(`deployable ${rel}`,exists(rel),exists(rel)?'present':'missing');
