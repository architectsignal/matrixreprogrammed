...
export function buildBriefEmail({kind='daily',source,baseUrl='https://matrixreprogrammed.com',date='',recipientTier='public'}={}){
  ...
  return{subject:`${brief.title} — ${brief.date}`,preheader:first(brief.executiveSummary,brief.topConclusions[0]).slice(0,180),htmlContent,textContent,canonicalRecordIds,evidenceCheckpointAt:brief.generatedAt,brief};
}
