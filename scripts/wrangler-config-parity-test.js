...
const requiredLockedVars = [
  ...
  'MATRIX_EVOLUTION_DIRECTOR_ENABLED',
  'MATRIX_SITE_OPERATOR_ENABLED',
  'MATRIX_CAPITAL_CHALLENGE_ENABLED',
  'MATRIX_CAPITAL_FINANCIAL_EXECUTION_ENABLED',
  'MATRIX_NOVEL_OPPORTUNITY_DIRECTOR_ENABLED'
  ,'MATRIX_BOUNTY_ENGINE_ENABLED'
  ,'MATRIX_BOUNTY_AUTO_CLAIM_ENABLED'
  ,'MATRIX_BOUNTY_AUTO_SUBMISSION_ENABLED'
  ,'MATRIX_SECURITY_BOUNTY_EXECUTION_ENABLED'
  ,'MATRIX_BOUNTY_MAX_ACTIVE'
];
