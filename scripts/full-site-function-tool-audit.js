...
const dynamicPrefixes = [
  '/api/', '/forum-', '/submit-', '/report-', '/track-', '/member-', '/billing-', '/admin-', '/newsletter-', '/osint-', '/health', '/deploy-status', '/intro-voice', '/intro-voice', '/intro-voice', '/intro-voice', '/intro-voice', '/intro-voice'
];
