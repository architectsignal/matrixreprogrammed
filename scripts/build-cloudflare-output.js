...
console.log(`Cloudflare output ready: ${count.length} deployable files, including Search V3 evidence-aware ranking, filters and fallback search while private diagnostics remain excluded.`);
