...
Updated: 2026-07-23T06:52:43.097Z
...
- **GREEN · Collect · fresh-current-news:** 38 news item(s) are inside the active seven-day window. Fix: Keep the homepage empty rather than showing stale news when this count reaches zero.
...
- **GREEN · Automate · daily-automation:** 131 workflow file(s) scanned for daily scheduling. Fix: Keep one canonical daily intake/conclusion/clock workflow and retire overlapping legacy schedules.
