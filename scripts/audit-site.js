...
const bannedPublicPhrases = [/ChatGPT/i, /author[- ]facing/i, /placeholder/i, /pending functionality/i, /awaiting API/i, /next build stage/i, /future build/i, /I can later/i, /TODO/i, /FIXME/i, /mapping needed/i, /ASIN missing/i, /once deployed/i, /generated by/i, /setup guide/i, /send exact/i, /sales door/i, /book sells the deep dive/i, /Use this page as a sales door/i];
...
for (const file of publicHtmlFiles) {
  ...
  if (!isInternalPage) {
    for (const phrase of bannedPublicPhrases) if (phrase.test(html)) problems.push(`${file}: public-facing copy contains banned build-note phrase: ${phrase}`);
  }
