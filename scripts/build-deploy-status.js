...
const homepageMarker = 'MAP THE STRUCTURE.';
const homepageLiveProof = 'MAP THE STRUCTURE. READ THE SIGNALS.';
...
const status = {
  ...
  liveProof: {
    homepageExpectedMarker: homepageLiveProof,
