# Trust And Evidence Pack

A briefing pack for claim labels, source hierarchy, corrections, privacy, association boundaries, machine-readable taxonomy, and public-interest anti-corruption discipline.

The evidence boundary is not weakness. It is what makes the archive stronger than noise.

## Weekly Mission

Keep the whole site credible: claim strength, source hierarchy, corrections, association boundary, private-victim protection, and machine-readable evidence taxonomy.

## Branded PDF Mini Book

- PDF: downloads/dossier-pack-trust-evidence.pdf
...
- corrections
- new claim labels
- public-content scrub issues
- forum test/demo posts
- stale intel cards
...
- 2026-06-17 — Ex-Cyprus President May Face Criminal Charges in Corruption Probe - Organized Crime and Corruption Reporting Project | OCCRP
  ...
  - Next: Open the source first, then follow the evidence route and only share the claim at the strength the record supports.
- 2026-06-11 — Democrats to call on Vance to testify to House committee over Epstein files - The Guardian
  ...
  - Next: Open the source first, then follow the evidence route and only share the claim at the strength the record supports.
- 2026-06-10 — Bill Gates tells US House ‘I have never victimized anyone’ in Epstein testimony - The Guardian
...
- Trust route: trust source methodology — trust-source-methodology.html
- Trust route: trust claim labels — trust-claim-labels.html
- Trust route: trust corrections — trust-corrections.html
- Source route: source cards — source-cards.html
- Evidence route: evidence vault index — evidence-vault-index.html
- Source route: claim taxonomy — claim-taxonomy.json
- Source route: crawler map — crawler-map.json
- Source route: public interest anti corruption charter — public-interest-anti-corruption-charter.json
...
- Google News / war machine: Senate Blocks FY2027 NDAA Over Iran War: $1.15T in Weapons Programs in Limbo - Tech Times — https://news.google.?oc=5
- Google News / control structure: The surveillance networks cities do not have to buy - Biometric Update — https://news.google.com/rss/articles/CBMilAFBVV95cUxQQnFleHUxeldqZ2N3V1RIQl9WVDk0TXhuSWgyRjBSUkU0WnNiUEpzNW93WHc1RE1sMEJUNUJxTDJROUZHYlNCZGtOYU9YQ1h3NkdPYmxCbS0xZzZFSGp3eHZhUVA2bXYyRVlBTGQ2aUNzQno4ekFPdmt1WUlWYkc4T1hQbVFhbHhHM0JOX09yVHhpVzd6?oc=5
- UN News: West Africa and the Sahel: Terrorism is changing its face — https://news.un.org/feed/view/en/story/2026/07/1167940
...
- JSON: downloads/forum-posts.json?pack=trust-evidence
- Markdown: downloads/forum-posts.md?pack=trust-evidence

## Core Pathways

- Trust pathway: trust-center.html
- Evidence pathway: evidence-vault-index.html
- Reader path: path-evidence-trust.html
- Machine pathway: claim-taxonomy.json

## Content Angles

- How to read the site safely
- Why association is not guilt
- What makes a source upgrade
- How speculation is labelled

## Takeaways

- Corrections strengthen the archive.
- Association is not guilt.
- Claim labels control claim strength.
- Machine-readable taxonomy should reflect evidence boundaries.
- A pack is useful only if the reader can see the source route and claim boundary.
