...
const report = {
  ...
  boundary: 'The regression fails if the browser omits credentials, the domains split sessions, D1 silently ignores a write, or a page can show success without read-after-write confirmation.'
};
