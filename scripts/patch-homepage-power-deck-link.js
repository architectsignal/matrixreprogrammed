...
<section id="power-deck-home-link" class="section wrap">
  <div class="eyebrow">Top Players · Greatest Hits</div>
  <div class="card redline" style="position:relative;overflow:hidden;background:radial-gradient(circle at 12% 20%,rgba(180,0,0,.28),transparent 26%),linear-gradient(135deg,rgba(18,0,0,.96),rgba(0,0,0,.94));">
    ...
    <h2>Top 52 Players</h2>
    <p class="lead">A 52-card map of the strongest public-record influence routes: governance, capital, security, narrative systems, missing records and convergence lanes.</p>
...
wr('index.html',html);
console.log('Homepage Power Deck link patched.');
