...
const blockedDirs = new Set(['.git','.github','node_modules','scripts','netlify','_site','evidence-archive','source-snapshots']);
...
console.log(`Cloudflare output ready: ${count.length} deployable files, including Phase 5 evidence-led public network maps, Search V3 and structured investigation data while private diagnostics remain excluded.`);
