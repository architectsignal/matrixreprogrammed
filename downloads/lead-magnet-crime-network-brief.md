# Crime Network Starter Brief

A practical reader brief for organized crime, cartel logistics, court records, sanctions, laundering routes, and crime-state overlap pages.

## Branded PDF Mini Book

- PDF: downloads/lead-magnet-crime-network-brief.pdf
...
Get the crime-network route while keeping association, indictment, sanction, conviction, and speculation boundaries clear.

## Reader Outcome

The reader knows how to follow crime-network records without turning association or investigation into automatic guilt.
...
- How court records, indictments, sanctions, convictions, and reporting differ.
- How to follow logistics, laundering, state protection, and cartel/mafia overlap.
- Which book path covers crime networks in greater depth.
- Why association boundaries matter when names appear in criminal cases.

## Checklist

- Open the court-record evidence lane.
- Check whether the record is charge, conviction, sanction, allegation, or association.
- Map logistics, money, protection, and violence separately.
- Open the Crime Dossiers page.
- Move into the crime offer if you want the complete series route.

## Action Steps

- Open the court-record lane.
- Read the association-boundary page.
- Open the Crime Dossiers page.
- Enter the Crime Dossiers offer.

## Routes

- Primary: book-crime-dossiers.html
- Thank you: black-file-thank-you.html
- Offer: offer-crime-dossiers.html
- Campaign: campaign-crime-state-overlap-push.html
- Share kit: share-kit-crime-state-overlap.html
- Download route: dossier-pack-crime-state-overlap.html
- Trust: trust-association-boundary.html
- Privacy: trust-privacy-policy.html
- Evidence: evidence-lane-court-records.html
- Evidence route: evidence-lane-court-records.html
- Evidence route: trust-association-boundary.html
- Evidence route: book-crime-dossiers.html
- Evidence route: network-maps.html

## Deliverables

- Crime dossier route
- Court-record boundary
- Crime-state map path
- Book-offer next step
- Association-boundary checklist
- Money/logistics trail prompts

## Next Best Step

Read the Crime Dossiers route or open the Crime Dossier offer.
