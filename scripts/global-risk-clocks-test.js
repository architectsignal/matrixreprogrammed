...
warnFile('forum.html');
warnFile('forum.js');
warnFile('functions/forum-feed.js');
warnFile('functions/submit-forum-post.js');
warnFile('functions/report-forum-post.js');
warnFile('data/forum-seed.json');
warnText('forum.html', 'The Signal Board');
warnText('forum.html', 'signal-board-feed');
warnText('forum.html', 'signal-board-form');
warnText('forum.html', 'forum.js');
warnText('forum.js', 'data/forum-seed.json');
warnText('forum.js', "FEED_ROUTE = '/forum-feed'");
warnText('forum.js', "SUBMIT_ROUTE = '/submit-forum-post'");
warnText('forum.js', "REPORT_ROUTE = '/report-forum-post'");
warnText('forum.js', 'LOCAL_POSTS_KEY');
warnText('forum.js', 'loadFallback');
warnText('forum.js', 'backend unavailable');
warnText('functions/forum-feed.js', 'FORUM_POSTS');
warnText('functions/submit-forum-post.js', 'FORUM_POSTS');
warnText('functions/report-forum-post.js', 'FORUM_POSTS');
warnText('functions/forum-feed.js', 'Access-Control-Allow-Origin');
warnText('functions/submit-forum-post.js', "FORUM_POSTS.put('posts'");
warnText('functions/report-forum-post.js', "FORUM_POSTS.put('reports'");
