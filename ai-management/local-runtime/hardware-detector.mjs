  ...
  for (const server of servers || []) {
    ...
    for (const model of server.models || []) {
      ...
      resources.push({
        ...
        approved_for_automation: memoryEligible, approved_data_classes: ['public', 'internal', 'confidential', 'restricted'], prohibited_data_classes: [],
        ...
        last_health_check: model.last_seen || now, health_status: memoryEligible ? 'healthy' : 'unhealthy', last_terms_check: now, terms_revalidation_due: null, last_quota_check: now,
        ...
        concurrency_limit: gpuMemoryGb >= estimatedNeed * 2 ? 2 : 1, fallback_resource_ids: [], implementation_status: memoryEligible ? 'production' : 'disabled',
