...
fs.writeFileSync(reportPath, `${JSON.stringify({
  ...
  boundary: 'Live verification proves the actual deployed email automation binding is false and uses the commit-bound health JSON rather than a cacheable presentation page.'
}, null, 2)}\n`);
